package ingsw.barattoManager.mvc.models;
...
import static com.barattoManager.old.manager.Constants.*;

/**
 * Class that handles users
 */
public final class UserModel implements Manager {
	 ...
	 */
	public UserModel(ConcurrentHashMap<String, User> userMap) {
