package ingsw.barattoManager.mvc.models.json;
 ...
 *         <i>The class must be recorded to listeners if you want to save the data with the method {@link Event#addListener(DataChangeListener) addListener}</i>
 *     </li>
 * </ul>
 *
