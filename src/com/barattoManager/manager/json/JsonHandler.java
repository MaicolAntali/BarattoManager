package com.barattoManager.manager.json;
 ...
 *     </li>
 *     <li>
 *         Thanks to the implementation of the {@link DataChangeListener}, save the data every time the data is updated.<br/>
 *         <i>The class must be recorded to listeners if you want to save the data with the method {@link com.barattoManager.event.Event#addListener(DataChangeListener) addListener}</i>
 *     </li>
 * </ul>
 *
 * @param <K> {@link DataChangeListener} and {@link ConcurrentHashMap} Key
 * @param <V> {@link DataChangeListener} and {@link ConcurrentHashMap} Value
 */
public class JsonHandler<K, V> implements DataChangeListener<K, V> {
