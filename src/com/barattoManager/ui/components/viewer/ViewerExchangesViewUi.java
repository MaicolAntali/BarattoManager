...
public class ViewerExchangesViewUi extends JPanel implements RepaintListener, DataChangeListener {
    ...
    public ViewerExchangesViewUi(Dimension dimension, CardLayout cardLayout, JPanel panelContainer, User user) {
        this.user = user;
        //this.articleTree = new ArticleTreeDashboard(user.getUsername(), Article.State.LINKED_OFFERT);
    ...
    public void repaintComponents() {
      /*  centerPanel.remove(articleTree);
        ...
        articleTree = new ArticleTreeDashboard(user.getUsername(), Article.State.LINKED_OFFERT);
