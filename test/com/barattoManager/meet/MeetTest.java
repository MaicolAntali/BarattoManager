...
class MeetTest {
	...
	void simpleIntervalsTest() throws IllegalValuesException {
		// start time = 10:00am
		// end time = 11:00am
		var meet = new Meet("test", "test", new ArrayList<>(List.of("Monday")), 10*60, 11*60, 3);
	...
	void complexIntervalsTest() throws IllegalValuesException {
		// start time = 10:10am
		// end time = 11:55am
		var meet = new Meet("test", "test", new ArrayList<>(List.of("Monday")), 10*60+10, 11*60+55, 3);
	...
	void equalsWithDifferenteTimeTest() throws IllegalValuesException {
		...
		var meet = new Meet("test", "test", new ArrayList<>(List.of("Monday")), 10*60, 15*60, 3);
		var meet2 = new Meet("test", "test", new ArrayList<>(List.of("Monday")), 11*60, 12*60+10, 3);
	...
	@Test
	void checkTime() {
		assertThrows(IllegalValuesException.class, () -> new Meet("test", "test", new ArrayList<>(List.of("Monday")), 18*60, 10*60, 3));
	}
}