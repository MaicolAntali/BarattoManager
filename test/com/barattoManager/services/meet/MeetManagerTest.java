...
class MeetManagerTest {
	...
	void addNewMeetWithoutCity() {
		assertThrows(InvalidArgumentException.class, () -> meetManagerInstance.addNewMeet("", "...", DayOfWeek.MONDAY, 100, 200, 1));
	}
	...
	void addNewMeetWrongIntervals() {
		assertThrows(InvalidArgumentException.class, () -> meetManagerInstance.addNewMeet("...", "...", DayOfWeek.MONDAY, 200, 100, 1));
	}

	@Test
	void addNewMeetDayBeforeExpireZero() {
		assertThrows(InvalidArgumentException.class, () -> meetManagerInstance.addNewMeet("...", "...", DayOfWeek.MONDAY, 100, 200, 0));
	}
	...
	void addMeetWithoutDays() {
		assertThrows(InvalidArgumentException.class, () -> meetManagerInstance.addNewMeet("...", "...", new ArrayList<>(), 770, 800, 1));
	}
